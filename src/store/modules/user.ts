...
class User extends VuexModule {
  // user info
  private userInfoState: GetUserInfoByUserIdModel | null = null;
  ...
  get getUserInfoState(): GetUserInfoByUserIdModel {
    return this.userInfoState || getAuthCache<GetUserInfoByUserIdModel>(USER_INFO_KEY) || {};
  }
  ...
  @Mutation
  commitUserInfoState(info: GetUserInfoByUserIdModel): void {
